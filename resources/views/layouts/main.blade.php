...
<html lang="en">
  <head>
    <title>Tzerzit | @yield("title"," Taghazout")</title>
    <meta charset="utf-8">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Restaurant<small>Tazerzit</small></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item {{session()->get('blog')??''}}"><a href="{{route('blog')}}" class="nav-link">Blog</a></li>
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-md-5">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{asset('/storage/images/image_1.jpg')}});"></a>
                <div class="text">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/Mouhcine.RSH" target="_blank">Mouhcine Jarir</a>
